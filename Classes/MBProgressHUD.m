...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = nil;
		self.labelFont = [UIFont fontWithName:@"Febrotesk 4F Unicase Bold" size:kLabelFontSize];
		self.detailsLabelFont = [UIFont fontWithName:@"Febrotesk 4F Unicase Bold" size:kDetailsLabelFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
