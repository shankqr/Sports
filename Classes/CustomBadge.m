...
- (void) autoBadgeSizeWithString:(NSString *)badgeString
{
	...
	CGSize stringSize = [badgeString sizeWithFont:[UIFont fontWithName:@"Febrotesk 4F Unicase Bold" size:12]];
	CGFloat flexSpace;
...
- (void)drawRect:(CGRect)rect {
	...
	if ([self.badgeText length]>0) {
		...
		UIFont *textFont = [UIFont fontWithName:@"Febrotesk 4F Unicase Bold" size:sizeOfFont];
