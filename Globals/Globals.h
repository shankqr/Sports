...
#define DEFAULT_FONT @"Trebuchet MS"
#define DEFAULT_FONT_BOLD @"Trebuchet MS Bold"
#define DEFAULT_FONT_SIZE 20.0f * SCALE_IPAD
...
#define MENU_FONT_SIZE (iPad ? 42.0f : 10.0f)
