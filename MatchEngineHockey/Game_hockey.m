...
- (void)loadClub
{
    ...
    for(NSDictionary *rowData in wsPlayersHome)
    {
        if (![rowData[@"player_id"] isEqualToString:@"0"])
        {
            ...
            {
                GK_total = GK_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:1 jersey:[wsClubHome[@"home_pic"] intValue] team:T_HOME role:P_GOALKEEPER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubHome[@"cd1"]])
            {
                DEFENDER_total = DEFENDER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:2 jersey:[wsClubHome[@"home_pic"] intValue] team:T_HOME role:P_DEFENDER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubHome[@"cd2"]])
            {
                DEFENDER_total = DEFENDER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:3 jersey:[wsClubHome[@"home_pic"] intValue] team:T_HOME role:P_DEFENDER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubHome[@"im1"]])
            {
                MIDFIELDER_total = MIDFIELDER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:4 jersey:[wsClubHome[@"home_pic"] intValue] team:T_HOME role:P_MIDFIELDER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubHome[@"im2"]])
            {
                MIDFIELDER_total = MIDFIELDER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:5 jersey:[wsClubHome[@"home_pic"] intValue] team:T_HOME role:P_MIDFIELDER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubHome[@"rw"]])
            {
                MIDFIELDER_total = MIDFIELDER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:6 jersey:[wsClubHome[@"home_pic"] intValue] team:T_HOME role:P_MIDFIELDER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubHome[@"lw"]])
            {
                MIDFIELDER_total = MIDFIELDER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:7 jersey:[wsClubHome[@"home_pic"] intValue] team:T_HOME role:P_MIDFIELDER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubHome[@"fw1"]])
            {
                ATTACKER_total = ATTACKER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:8 jersey:[wsClubHome[@"home_pic"] intValue] team:T_HOME role:P_ATTACKER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubHome[@"fw2"]])
            {
                ATTACKER_total = ATTACKER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:9 jersey:[wsClubHome[@"home_pic"] intValue] team:T_HOME role:P_ATTACKER name:rowData[@"player_name"]];
            }
    ...
    if (GK_total == 0)
    {
        Player_hockey *p = [Player_hockey initPlayer:-1 number:1 jersey:[wsClubHome[@"home_pic"] intValue] team:T_HOME role:P_GOALKEEPER name:@"GK_HOME"];
    ...
    for(NSDictionary *rowData in wsPlayersAway)
    {
        if (![rowData[@"player_id"] isEqualToString:@"0"])
        {
            ...
            {
                GK_total = GK_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:1 jersey:[wsClubAway[@"away_pic"] intValue] team:T_AWAY role:P_GOALKEEPER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubAway[@"cd1"]])
            {
                DEFENDER_total = DEFENDER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:2 jersey:[wsClubAway[@"away_pic"] intValue] team:T_AWAY role:P_DEFENDER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubAway[@"cd2"]])
            {
                DEFENDER_total = DEFENDER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:3 jersey:[wsClubAway[@"away_pic"] intValue] team:T_AWAY role:P_DEFENDER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubAway[@"im1"]])
            {
                MIDFIELDER_total = MIDFIELDER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:4 jersey:[wsClubAway[@"away_pic"] intValue] team:T_AWAY role:P_MIDFIELDER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubAway[@"im2"]])
            {
                MIDFIELDER_total = MIDFIELDER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:5 jersey:[wsClubAway[@"away_pic"] intValue] team:T_AWAY role:P_MIDFIELDER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubAway[@"rw"]])
            {
                MIDFIELDER_total = MIDFIELDER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:6 jersey:[wsClubAway[@"away_pic"] intValue] team:T_AWAY role:P_MIDFIELDER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubAway[@"lw"]])
            {
                MIDFIELDER_total = MIDFIELDER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:7 jersey:[wsClubAway[@"away_pic"] intValue] team:T_AWAY role:P_MIDFIELDER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubAway[@"fw1"]])
            {
                ATTACKER_total = ATTACKER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:8 jersey:[wsClubAway[@"away_pic"] intValue] team:T_AWAY role:P_ATTACKER name:rowData[@"player_name"]];
            }
            if ([rowData[@"player_id"] isEqualToString:wsClubAway[@"fw2"]])
            {
                ATTACKER_total = ATTACKER_total + 1;
                p = [Player_hockey initPlayer:[[rowData[@"player_id"] stringByReplacingOccurrencesOfString:@"," withString:@""] intValue] number:9 jersey:[wsClubAway[@"away_pic"] intValue] team:T_AWAY role:P_ATTACKER name:rowData[@"player_name"]];
            }
    ...
    if (GK_total == 0)
    {
        Player_hockey *p = [Player_hockey initPlayer:-2 number:1 jersey:[wsClubAway[@"away_pic"] intValue] team:T_AWAY role:P_GOALKEEPER name:@"GK_AWAY"];
...
- (void)onEnterFrame:(SPEnterFrameEvent *)event
{
    ...
    if((ball.outOfPlay || ball.saved) && (goalCountdown < 0) && !finished && played)
    {
        ...
        //highlightTextField.text = [NSString stringWithFormat:@"%@, %d'th minute",
                                   //[players[[highlight[@"player_row"] intValue]] name],
